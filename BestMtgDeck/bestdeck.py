...
class Deck:
    def __init__(self, name: str, mainboard: dict, format_name: str, formato: dict, coll_dict: dict,
        ...
        for card in self.total:
            ...
            if self.arena is True and card not in BASIC_LANDS:  # basic land don't matter
                ...
                try:
                    card_rarity = rarity[card]
                except KeyError:
                    card_rarity = rarity[card.split(" // ")[0]]
    ...
    def add_list(self, main_or_side) -> list:
        ...
        for card in main_or_side:
            ...
            temp = {'name': card_name, 'copies_total': main_or_side[card]}
